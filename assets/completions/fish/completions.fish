...
complete -c flake-edit -n "__fish_seen_subcommand_from follow" -f -a "(__fish_complete_follow)" -d "Input path"
complete -c flake-edit -n "__fish_seen_subcommand_from f" -f -a "(__fish_complete_follow)" -d "Input path"
