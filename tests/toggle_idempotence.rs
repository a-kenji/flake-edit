...
/// First use of a new ref synthesizes an alternate. From then on the
...
/// `--remove` through the active url is the inverse of first-use
/// synthesis: storing a new ref and then removing it restores the file
/// byte for byte.
#[test]
